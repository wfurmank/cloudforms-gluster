...
#            Automate Method
#
$evm.log("info", "dgv_notify Automate Method Started **************************")
#
...
subject = "CloudForms: Delete Gluster Volume request"

# Formatting email mesage
body  = "Dear #{user.name},\n"
body += "<br>\n<br>Your <i>Delete Gluster Volume</i> request has been completed.\n"
body += "<br>\n<br>\n<br>-----\n"
