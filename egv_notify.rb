...
#            Automate Method
#
$evm.log("info", "egv_notify Automate Method Started **************************")
#
...
body  = "Dear #{user.name},\n"
body += "<br>\n<br>The following message was genereated per your <i>Extend Gluster Volume</i> request.\n<br>\n"
body += "<br>The following Gluster Volume has been extended:\n"
body += message
body += "<br>\n<br>\n<br>-----\n"
