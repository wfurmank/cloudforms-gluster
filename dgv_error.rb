...
#            Automate Method
#
$evm.log("info", "gdv_error Automate Method Started ***************************")
#
...
subject = "CloudForms: Delete Gluster Volume request ERROR"

# Formatting email mesage
body  = "Dear #{user.name},\n"
body += "<br>\n<br>An error has ocurred during your <i>Delete Gluster Volume</i> request.\n"
body += "<br>\n<br>\n<br>-----\n"
