...
#            Automate Method
#
$evm.log("info", "lgs_notify Automate Method Started *************************")
#
...
body  = "Dear #{user.name},\n"
body += "<br>\n<br>The following message was genereated per your <i>List Gluster Storage</i> request.\n<br>\n"
body += "<br>Available free space in Gluster Storage Systems:\n<br>\n"
body += message
body += "<br>\n<br>\n<br>-----\n"
...
#
#
$evm.log("info", "lgs_notify Automate Method Ended")
exit MIQ_OK
